...
const LoginPage = () => {
  return (
    <div className="h-screen flex items-center justify-center bg-lamaSkyLight max-sm:px-3 overflow-x-hidden overflow-auto">
      <SignIn.Root>
        <SignIn.Step
          name="start"
          className="sm:w-[22rem] bg-white p-12 rounded-md shadow-2xl flex flex-col gap-2"
        >
          <h1 className="text-xl font-bold flex items-center gap-2">
            <Image src={"/logo.png"} alt="" width={24} height={24} /> School
            Suite{" "}
          </h1>
