...
const renderRow = (item: AssignmentList) => (
  ...
  >
    ...
    <td className="hidden md:table-cell px-4">{item?.lesson.teacher.name + ' ' + item?.lesson.teacher.surname}</td>
    <td className="hidden md:table-cell px-4">{item.dueDate ? new Intl.DateTimeFormat('en-US').format(new Date(item.dueDate)) : 'N/A'}</td>
    <td>
