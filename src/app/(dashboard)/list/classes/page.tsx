...
const renderRow = (item: ClassList) => (
  ...
  >
    ...
    <td className="hidden md:table-cell px-4">{item?.capacity}</td>
    <td className="hidden md:table-cell px-4">{item?.name[0]}</td>
    <td className="hidden md:table-cell px-4">{item?.supervisor.name + ' ' + item?.supervisor.surname}</td>
    <td>
